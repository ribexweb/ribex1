...
$( document ).ready(function() {
    ...
    $(document).on('change','.booleano_activo_usos',function(event){   
        if (paginaActiva.code == 23){
            ...
            updateFieldBoolean("Usos",
                "mediciones.usos",
                {field:"iduso",value:id,type:'integer'},
        ...
        $.ajax({
            ...
            success: function( data, textStatus, jQxhr ){
                    if (data[0].tipo == "success"){
                        ...
                        guardar_log(data[0].return[0]["iduso"],elementos["tableName"],elementos["operacion"],JSON.stringify(elementos["campos"]),usuarioActivo);
        ...
        $.ajax({
            ...
            success: function( data, textStatus, jQxhr ){
                if (data[0].tipo == "success"){
                    ...
                    guardar_log(iduso,elementos["tableName"],elementos["operacion"],JSON.stringify(elementos["campos"]),usuarioActivo);
                }
                else {
                    console.log(data);
                    error2({
