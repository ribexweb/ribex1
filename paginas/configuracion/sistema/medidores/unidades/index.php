...
<section class="content">
    <div class="box box-primary" style="background-color:#f4f4f4;">
        <div class="box-header">
            <h3 class='text-secondary'>
                ...
                Unidades <small>Unidades para Variables</small>
            </h3>
        </div>
        <div class="box-body">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <table id="tablaUnidades" class="table table-bordered table-striped" style="width:100%">
                        <thead>
                            <td>Código</td>
                            <td>Descripción</td>
                            <td>Activo</td>
            ...
            <div id="divOperaciones" class="box box-primary hidden">
                <div class="box-header">
                    <h4>
                        <i class="fa fa-list-alt fa-lg"></i>
                        <span id="lbTitulo">Unidades</span>
                    </h4>
                    <h5><b><span id="lbTituloDescripcion">Ingresar o Modificar Unidades</span></b></h5>
                </div>
                <div class="box-body"> 
                    <form id="FormaParametros">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">  
                                <label>Nombre</label>
                                <input type="text" class="form-control" id="TextCodigo" name="TextCodigo" autocomplete="off" data-smk-msg="Código de Unidad requerido" required>
                            </div>  
                            <div class="form-group col-md-4"> 
    ...
    <script src='<?php echo pathinfo($_SERVER["SCRIPT_NAME"])["dirname"];?>/code35.js?<?php echo time(); ?>'></script>

<script>
    edificios = '<?php wr(getDataSesion('edificios','idedificio'));?>';
    var reporteUnidades = {activo:false,inicio:0,final:0,data:[]};
    var idUnidadActual = 0;
    
    var tableParamsUnidades = { 
        responsive:true,
        destroy: true,
        paging: true,
        searching: true,
        ...
        ajax:{
            ...
            type: "POST",
            data:function(d){
                d.primaryField = "idunidad";
                d.show = {
                    fields:["idunidad","codigo","descripcion","activo"],
            ...
            dataSrc: function(data){  
                reporteUnidades.data = data.resultados[0].resultados;         
                return data.data;                 
            },
    ...
    var tablaUnidades = $("#tablaUnidades").DataTable(tableParamsUnidades); 
