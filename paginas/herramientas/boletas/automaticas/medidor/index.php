        ...
        <div class="col-md-9">
            <div class="box box-primary">
                ...
                <div class="text-right">
                    <button type="button" id="descargarTodasMedidor" data-iddashboard="0" data-toggle="modal" data-target="#widgetModal" class="btn btn-info"><i class='fa fa-download'> </i> Descargar Todos</button><p>
                </div> 
