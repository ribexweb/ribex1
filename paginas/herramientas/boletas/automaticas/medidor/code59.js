...
*/
            ajaxParams = {
                ...
                data:function(d){
                    ...
                    d.queries=[{
                        fieldsSelect:["idremarcacionasignacion","desde","hasta","fecha::date","extract('year' from fecha) as ano","lpad(extract('month' from fecha)::text,2,'0') as mes","sumavaloresfacturados.total","sumavaloresfacturados.total*1.19 as totaliva"],
