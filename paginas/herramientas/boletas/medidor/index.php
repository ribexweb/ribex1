...
<section class="content-header">
      <h1>
        Boletas Generadas
        <small>Boletas generadas por medidor a la fecha</small>
      </h1>
</section>
...
dataTable = $('#tabla').DataTable({
    ...
    "ajax":{
      ...
      type: "POST",
      data:{ 
        primaryField: "idboleta",
        hide:["ano","mes","idasignacion","idedificio","grupo"],
        show: {
          fields:["ano","mes","fecha","desde","hasta","monto"],
          deletebtn:0,
          updatebtn:0,
