...
<section class="content-header">
    <h1>
        ...
        <small>Detalles de Facturación</small>
    </h1>
</section>
...
<script src='<?php echo pathinfo($_SERVER["SCRIPT_NAME"])["dirname"];?>/code82.js?<?php echo time();?>'></script>
    ...
    if (edificios != '') {
        selectJs2(
            ...
            { 
                ...
                hide: ["idedificio"],
                queries:[{
                    fieldsSelect:["vedificios.idedificio","vedificios.nombre"],
