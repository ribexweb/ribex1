...
<section class="content-header">
    <h1>
        Consumo Energético vs Presupuestado 
        <small>Reporte de Energia</small>
    </h1>
</section>
...
<script src='<?php echo pathinfo($_SERVER["SCRIPT_NAME"])["dirname"];?>/code83.js?<?php echo time();?>'></script>
    ...
    if (edificios != '') {
        selectJs2(
            ...
            { 
                ...
                hide: ["idedificio","idpresupuesto"],
                queries:[{
                    fieldsSelect:["vedificios.idedificio","vedificios.nombre","coalesce(edificios.idmedidorprincipal,-1) as idpresupuesto",],
