...
<section class="content-header">
      <h1>
        Energía Grupos de Medidores
        <small>Gráficos de Energia ingresada por Grupos de Medidores</small>
      </h1>
</section>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <thead class='text-center'>
                                        ...
                                        <tr><td id='tbGrupo' colspan=4>Grupo</td></tr>
                                        ...
                                        <tr><td class='text-center' width='40%'>Descripción</td>
                                            ...
                                            <td class='text-center' width='20%'>Porcentaje</td>
                                        </tr>
                                </thead>
                                    <tbody>
                                    </tbody>
