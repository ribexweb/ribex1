...
<section class="content-header">
      <h1>
        Consumos por Arrendatarios
        <small>Gráficos de Consumos Históricos por Arrendatarios</small>
      </h1>
</section>
                ...
                <div class="box-body" style="">
                    ...
                    <form id="FormaParametros" role="form">
                        <div class="box-body">
                            ...
                            <div class="row form-group">
                                <div class="col col-md-12">
                                    <label>Arrendatarios</label>
                                    <select id="SelectArrendatario" name="SelectArrendatario" class="form-control select2" style="width: 100%;">
                                    </select>
                                </div>
                            </div>
...
<script src='<?php echo pathinfo($_SERVER["SCRIPT_NAME"])["dirname"];?>/code76.js?<?php echo time(); ?>'></script>
            ...
            plugins:{
                datalabels: {
                        ...
                        color:function(context) {
                            //color = tinycolor(context.dataset.backgroundColor);
                            //.complement().toRgbString();
                            //console.log(color.getBrightness());
                            //return (tinycolor(context.dataset.backgroundColor).getBrightness()<127.5)?'rgb(255,255,255)':'rgb(0,0,0)';
                            //return tinycolor(context.dataset.backgroundColor).complement().toRgbString();
                            return 'rbga(0,0,0,1)';
                        },
                        font:{
                            //weight:'bold',
                        ...
                        formatter: function(value, context) {
                            return parseFloat(value).toLocaleString("es")
                        }
                },   
                labels: false,
                /*[
