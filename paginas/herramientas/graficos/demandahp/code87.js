                ...
                graficoLinealJs2(
                    ...
                    {   
                        ...
                        queries:[{
                            ...
                            tableName   :"mediciones.consultar_medidor_variable(%s,%s,'%s','%s','%s')".format($("#SelectMedidor").val(),$("#SelectVariable").val(),fechainicial,fechafinal,database),
                            orderby:[{
                                field:"fecha",
                                type : "asc"
                            }],
                            ...
                            groupby:[
                                "TO_TIMESTAMP(concat(fecha::date,' ',extract(hour from fecha)::text,':',extract(minute from fecha)::text),'YYYY-MM-DD HH24:mi')",
                            ]
                        }],
                    },
                    {   
