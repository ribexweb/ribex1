...
<section class="content-header">
      <h1>
        Funciones
        <small>Clasificaciones de la Función del Medidor</small>
      </h1>
</section>
      ...
      <div class="box">
        <div class="box-body">
          <div class="text-right">
            <button type="button" id="nuevoFuncion" data-toggle="modal" data-target="#ModalFuncion" class="btn btn-info btn-sm"><i class='fa fa-plus'> </i> Nuevo</button>
          </div>
...
<script>
    ...
    */
    ...
    var dtFunciones = $('#tablaFunciones').DataTable({
            "processing":false,
            //"serverSide":true,
            "order":[],
            "ajax":{
