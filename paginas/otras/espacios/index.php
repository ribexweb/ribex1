...
<section class="content-header">
      <h1>
        Espacios
        <small>Lugares de Edificios</small>
      </h1>
</section>
      ...
      <div class="box">
        <div class="box-body">
          <div class="text-right">
            <button type="button" id="nuevoEspacio" data-toggle="modal" data-target="#ModalEspacio" class="btn btn-info btn-sm"><i class='fa fa-plus'> </i> Nuevo</button>
          </div>
          <table id="tablaEspacios" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th>Nombre</th>
                <th>Descripción</th>
...
<script>
    ...
    */
    ...
    var dtEspacios = $('#tablaEspacios').DataTable({
            "processing":false,
            //"serverSide":true,
            "order":[],
            "ajax":{
