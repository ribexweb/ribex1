        ...
        <form id="FormaParametros">
            ...
            <div class="form-row">
                <div id='container-colorpicker1' class="form-group col col-md-6 widget">
                    <label for="colorpicker1">Color Presupuesto</label>
                    <br>
                    <input id='colorpicker1' type="text" class="form-control colorrgb"  value="rgba(240, 204, 0, 0.8)">
                </div> 
                <div id='container-colorpicker2' class="form-group col col-md-6 widget">
                    <label for="colorpicker2">Color Real</label>
                    <br>
                    <input id='colorpicker2' type="text" class="form-control colorrgb"  value="rgba(27, 109, 193, 0.8)">
                </div>
            </div>
    ...
    function loadWidget(){
        ...
        .then(function(data) {
            ...
            if (data[0].resultados.length > 0) {
                ...
                $("#checkshTitulo").attr("checked",(json[13]=='true'));
            }    
        })
        .done(function(xhr){
