...
<div id="divOperaciones" class="box box-primary">
    <div class="box-body"> 
        <form id="FormaParametros">
            ...
            <div class="row form-row">
                <div id='container-maximo' class="form-group col col-md-6 widget">
                    <label>Valor Máximo</label>
                    <input type="text" class="form-control" id="textMaxima" name="textMaxima" autocomplete="off" data-smk-msg="Máximo valor de potencia requerido" required>
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4 text-center">
                    <label for="checkshCodigo">Mostrar Nombre</label>
                    <span id="iconoAdjunto" class="input-group-btn">
                ...
                <div class="form-group col-md-4 text-center">
                    <label for="checkshMedidor">Mostrar Codigo</label>
                    <span id="iconoAdjunto" class="input-group-btn">
                        <label class="cl-switch cl-switch-green cl-switch-large"><input id="checkshMedidor" checked="false" type="checkbox"><span class="switcher"></span></label>
                    </span>
                </div> 
            </div>
            <div class="form-row">
                ...
                <div class="form-group col-md-6 text-center">
                    <label for="checkshTitulo">Mostrar Título</label>
                    <span id="iconoAdjunto" class="input-group-btn">
...
<script>
    ...
    function loadProteccion(idmedidor){
        $.ajax({
        url:"php/data.php?proteccion",
            method:"POST",
            data:{
                queries:[{
                    fieldsSelect:["*"],
            ...
            success:function(data){
                if ((data.length > 0) && (data[0].resultados.length > 0)){
                    $("#textMaxima").val(data[0].resultados[0].proteccion);
                }        
            }
        });        
    }
