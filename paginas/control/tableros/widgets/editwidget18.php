...
<div id="divOperaciones" class="box box-primary">
    <div class="box-body"> 
        <form id="FormaParametros">
            ...
            <div class="row form-row">
                <div id='container-colorpicker1' class="form-group col col-md-4 widget">
                    <label for="colorpicker1">Color Máximo</label>
                    <br>
                    <input id='colorpicker1' type="text" class="form-control colorrgb"  value="rgba(235, 231, 0, 0.8)">
                </div> 
                <div id='container-colorpicker2' class="form-group col col-md-4 widget">
                    <label for="colorpicker2">Color Mínimo</label>
                    <br>
                    <input id='colorpicker2' type="text" class="form-control colorrgb"  value="rgba(0, 51, 204, 0.8)">
                </div>
                <div id='container-colorpicker3' class="form-group col col-md-4 widget">
                    <label for="colorpicker3">Color Promedio</label>
                    <br>
                    <input id='colorpicker3' type="text" class="form-control colorrgb"  value="rgba(0, 189, 28, 0.8)">
                </div>
            </div>
            <div class="row form-row">
    ...
    function loadWidget(){
        ...
        .then(function(data) {
            ...
            if (data[0].resultados.length > 0) {
                ...
                $("#colorpicker3").minicolors('value',json[6]); 
