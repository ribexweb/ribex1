        ...
        <form id="FormaParametros">
            ...
            <div class="row form-row">
                <div id='container-colorpicker1' class="form-group col col-md-6 widget">
                    <label for="colorpicker1">Color de Meses</label>
                    <br>
                    <input id='colorpicker1' type="text" class="form-control colorrgb"  value="rgba(45,10,80,0.6)">
                </div> 
            </div>
            <div class="row form-row">
    ...
    function loadWidget(){
        ...
        .then(function(data) {
            ...
            if (data[0].resultados.length > 0) {
                ...
                $("#checkshNombre").attr("checked",(json[9]=='true'));
