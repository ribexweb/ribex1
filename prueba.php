...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <!-- Content Wrapper. Contains page content -->
        ...
        <div id="container-widget-2241" class="col-md-3">
          <button id="btnCloseWidget2241" data-id="2241" class="close closeWidget hidden" type="button" style="position:relative;z-index:10;"><i class="fa fa-window-close" style="color:#000 !important;"></i></button>
          <button id="btnEditWidget2241" data-id="2241" data-tipo="3" data-tipotexto="Potencia Actual" class="close editWidget hidden" type="button" style="position:relative;z-index:10"><i class="fa fa-pencil-alt" style="color:#000 !important;"></i></button>
          <div class="small-box" style="background-color:rgba(0, 70, 230, 0.8);color:rgba(255, 255, 255, 1)">
            <div class="inner">
              <h3 id="PotenciaActualValor2241">0 kW</h3>
              <small>Me-PAK-21201 </small><br>
              <small> </small><br>
              <small>Potencia Actual<p></p></small>
            </div>
            <div class="icon">
        ...
        <div id="container-widget-2241" class="col-md-3">
          <button id="btnCloseWidget2241" data-id="2241" class="close closeWidget hidden" type="button" style="position:relative;z-index:10;"><i class="fa fa-window-close" style="color:#000 !important;"></i></button>
          <button id="btnEditWidget2241" data-id="2241" data-tipo="3" data-tipotexto="Potencia Actual" class="close editWidget hidden" type="button" style="position:relative;z-index:10"><i class="fa fa-pencil-alt" style="color:#000 !important;"></i></button>
          <div class="small-box" style="background-color:rgba(60, 150, 0, 0.8);color:rgba(255, 255, 255, 1)">
            <div class="inner">
                <div class='row'>
                  <div class='col col-md-12'> 
                    <h3 id="EnergiaActual2241">454456 kWh</h3>
                  </div>  
                </div>    
                <div class='row'>
                  <div class='col col-md-12'>
                    <h3 id="PotenciaActual2241">567 kW</h3>
                  </div>  
                </div>
                <div class='row'>
              ...
              <div class='row'>
                ...
                <div class='col col-md-7 text-right'>               
                  456 kW (2019-02-01 10:45)
                </div>  
              </div>
              <div class='row'>
                  <div class='col col-md-5'> 
                    <b>Últ.Actualización</b>:
                  </div>  
                  <div class='col col-md-7 text-right'> 
                    2019-12-02 21:15
                  </div>  
